...
const MODULES: { key: string; icon: string; cls: string; st: St; href?: string; admin?: boolean }[] = [
  ...
  { key: 'forms', icon: P.building, cls: 'ic-cyan', st: 'done', href: '/settings/forms?form=organization' },
  { key: 'forms_driver', icon: P.user, cls: 'ic-cyan', st: 'done', href: '/settings/forms?form=driver' },
  { key: 'forms_vehicle', icon: P.car, cls: 'ic-cyan', st: 'done', href: '/settings/forms?form=vehicle' },
  { key: 'forms_employee', icon: P.users, cls: 'ic-cyan', st: 'done', href: '/settings/forms?form=employee' },
  ...
  { key: 'backup', icon: P.shield, cls: 'ic-blue', st: 'done', href: '/settings/backup' },
  { key: 'performance', icon: P.chart, cls: 'ic-purple', st: 'done', href: '/settings/performance' },
  { key: 'interface', icon: P.globe, cls: 'ic-cyan', st: 'done', href: '/settings/interface' },
];
