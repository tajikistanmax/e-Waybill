...
export const P = {
  ...
  // Служба поддержки — гарнитура оператора (наушники с микрофоном).
  headset: 'M3 11h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-5a9 9 0 0 1 18 0v5a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3M21 16v2a4 4 0 0 1-4 4h-5',
  // «Бургер» — свернуть/развернуть боковое меню.
  menu: 'M4 6h16M4 12h16M4 18h16',
  // Карандаш — правка записи.
